...
ALTER TABLE ADMISSIONS
  DROP CONSTRAINT IF EXISTS admissions_fk_subject_id;
ALTER TABLE ADMISSIONS
...
-- subject_id
ALTER TABLE CALLOUT
  DROP CONSTRAINT IF EXISTS callout_fk_subject_id;
ALTER TABLE CALLOUT
...
-- hadm_id
ALTER TABLE CALLOUT
  DROP CONSTRAINT IF EXISTS callout_fk_hadm_id;
ALTER TABLE CALLOUT
...
ALTER TABLE CHARTEVENTS
  DROP CONSTRAINT IF EXISTS chartevents_fk_subject_id;
ALTER TABLE CHARTEVENTS
...
-- cgid
ALTER TABLE CHARTEVENTS
  DROP CONSTRAINT IF EXISTS chartevents_fk_cgid;
ALTER TABLE CHARTEVENTS
...
-- hadm_id
ALTER TABLE CHARTEVENTS
  DROP CONSTRAINT IF EXISTS chartevents_fk_hadm_id;
ALTER TABLE CHARTEVENTS
...
-- item_id
ALTER TABLE CHARTEVENTS
  DROP CONSTRAINT IF EXISTS chartevents_fk_itemid;
ALTER TABLE CHARTEVENTS
...
-- icustay_id
ALTER TABLE CHARTEVENTS
  DROP CONSTRAINT IF EXISTS chartevents_fk_icustay_id;
ALTER TABLE CHARTEVENTS
...
ALTER TABLE CPTEVENTS
  DROP CONSTRAINT IF EXISTS cptevents_fk_subject_id;
ALTER TABLE CPTEVENTS
...
-- hadm_id
ALTER TABLE CPTEVENTS
  DROP CONSTRAINT IF EXISTS cptevents_fk_hadm_id;
ALTER TABLE CPTEVENTS
...
ALTER TABLE DATETIMEEVENTS
  DROP CONSTRAINT IF EXISTS datetimeevents_fk_subject_id;
ALTER TABLE DATETIMEEVENTS
...
-- cgid
ALTER TABLE DATETIMEEVENTS
  DROP CONSTRAINT IF EXISTS datetimeevents_fk_cgid;
ALTER TABLE DATETIMEEVENTS
...
-- hadm_id
ALTER TABLE DATETIMEEVENTS
  DROP CONSTRAINT IF EXISTS datetimeevents_fk_hadm_id;
ALTER TABLE DATETIMEEVENTS
...
-- item_id
ALTER TABLE DATETIMEEVENTS
  DROP CONSTRAINT IF EXISTS datetimeevents_fk_itemid;
ALTER TABLE DATETIMEEVENTS
...
-- icustay_id
ALTER TABLE DATETIMEEVENTS
  DROP CONSTRAINT IF EXISTS datetimeevents_fk_icustay_id;
ALTER TABLE DATETIMEEVENTS
...
ALTER TABLE DIAGNOSES_ICD
  DROP CONSTRAINT IF EXISTS diagnoses_icd_fk_subject_id;
ALTER TABLE DIAGNOSES_ICD
...
-- hadm_id
ALTER TABLE DIAGNOSES_ICD
  DROP CONSTRAINT IF EXISTS diagnoses_icd_fk_hadm_id;
ALTER TABLE DIAGNOSES_ICD
...
ALTER TABLE DRGCODES
  DROP CONSTRAINT IF EXISTS drgcodes_fk_subject_id;
ALTER TABLE DRGCODES
...
-- hadm_id
ALTER TABLE DRGCODES
  DROP CONSTRAINT IF EXISTS drgcodes_fk_hadm_id;
ALTER TABLE DRGCODES
...
ALTER TABLE ICUSTAYS
  DROP CONSTRAINT IF EXISTS icustays_fk_subject_id;
ALTER TABLE ICUSTAYS
...
-- hadm_id
ALTER TABLE ICUSTAYS
  DROP CONSTRAINT IF EXISTS icustays_fk_hadm_id;
ALTER TABLE ICUSTAYS
...
ALTER TABLE INPUTEVENTS_CV
  DROP CONSTRAINT IF EXISTS inputevents_cv_fk_subject_id;
ALTER TABLE INPUTEVENTS_CV
...
-- hadm_id
ALTER TABLE INPUTEVENTS_CV
  DROP CONSTRAINT IF EXISTS inputevents_cv_fk_hadm_id;
ALTER TABLE INPUTEVENTS_CV
...
-- icustay_id
ALTER TABLE INPUTEVENTS_CV
  DROP CONSTRAINT IF EXISTS inputevents_cv_fk_icustay_id;
ALTER TABLE INPUTEVENTS_CV
...
-- cgid
ALTER TABLE INPUTEVENTS_CV
  DROP CONSTRAINT IF EXISTS inputevents_cv_fk_cgid;
ALTER TABLE INPUTEVENTS_CV
...
ALTER TABLE INPUTEVENTS_MV
  DROP CONSTRAINT IF EXISTS inputevents_mv_fk_subject_id;
ALTER TABLE INPUTEVENTS_MV
...
-- hadm_id
ALTER TABLE INPUTEVENTS_MV
  DROP CONSTRAINT IF EXISTS inputevents_mv_fk_hadm_id;
ALTER TABLE INPUTEVENTS_MV
...
-- icustay_id
ALTER TABLE INPUTEVENTS_MV
  DROP CONSTRAINT IF EXISTS inputevents_mv_fk_icustay_id;
ALTER TABLE INPUTEVENTS_MV
...
ALTER TABLE INPUTEVENTS_MV
  DROP CONSTRAINT IF EXISTS inputevents_mv_fk_itemid;
ALTER TABLE INPUTEVENTS_MV
...
-- cgid
ALTER TABLE INPUTEVENTS_MV
  DROP CONSTRAINT IF EXISTS inputevents_mv_fk_cgid;
ALTER TABLE INPUTEVENTS_MV
...
ALTER TABLE LABEVENTS
  DROP CONSTRAINT IF EXISTS labevents_fk_subject_id;
ALTER TABLE LABEVENTS
...
-- hadm_id
ALTER TABLE LABEVENTS
  DROP CONSTRAINT IF EXISTS labevents_fk_hadm_id;
ALTER TABLE LABEVENTS
...
-- item_id
ALTER TABLE LABEVENTS
  DROP CONSTRAINT IF EXISTS labevents_fk_itemid;
ALTER TABLE LABEVENTS
...
ALTER TABLE MICROBIOLOGYEVENTS
  DROP CONSTRAINT IF EXISTS microbiologyevents_fk_subject_id;
ALTER TABLE MICROBIOLOGYEVENTS
...
ALTER TABLE MICROBIOLOGYEVENTS
  ADD CONSTRAINT microbiologyevents_fk_spec_itemid
    FOREIGN KEY (spec_itemid)
      REFERENCES D_ITEMS (itemid);
ALTER TABLE MICROBIOLOGYEVENTS
  DROP CONSTRAINT IF EXISTS microbiologyevents_fk_org_itemid;
ALTER TABLE MICROBIOLOGYEVENTS
...
ALTER TABLE NOTEEVENTS
  DROP CONSTRAINT IF EXISTS noteevents_fk_subject_id;
ALTER TABLE NOTEEVENTS
...
-- hadm_id
ALTER TABLE NOTEEVENTS
  DROP CONSTRAINT IF EXISTS noteevents_fk_hadm_id;
ALTER TABLE NOTEEVENTS
...
-- cgid
ALTER TABLE NOTEEVENTS
  DROP CONSTRAINT IF EXISTS noteevents_fk_cgid;
ALTER TABLE NOTEEVENTS
...
ALTER TABLE OUTPUTEVENTS
  DROP CONSTRAINT IF EXISTS outputevents_subject_id;
ALTER TABLE OUTPUTEVENTS
...
-- hadm_id
ALTER TABLE OUTPUTEVENTS
  DROP CONSTRAINT IF EXISTS outputevents_hadm_id;
ALTER TABLE OUTPUTEVENTS
...
-- icustay_id
ALTER TABLE OUTPUTEVENTS
  DROP CONSTRAINT IF EXISTS outputevents_icustay_id;
ALTER TABLE OUTPUTEVENTS
...
-- itemid
ALTER TABLE OUTPUTEVENTS
  DROP CONSTRAINT IF EXISTS outputevents_fk_itemid;
ALTER TABLE OUTPUTEVENTS
...
-- cgid
ALTER TABLE OUTPUTEVENTS
  DROP CONSTRAINT IF EXISTS outputevents_cgid;
ALTER TABLE OUTPUTEVENTS
...
ALTER TABLE PRESCRIPTIONS
  DROP CONSTRAINT IF EXISTS prescriptions_fk_subject_id;
ALTER TABLE PRESCRIPTIONS
...
-- hadm_id
ALTER TABLE PRESCRIPTIONS
  DROP CONSTRAINT IF EXISTS prescriptions_fk_hadm_id;
ALTER TABLE PRESCRIPTIONS
...
-- icustay_id
ALTER TABLE PRESCRIPTIONS
  DROP CONSTRAINT IF EXISTS prescriptions_fk_icustay_id;
ALTER TABLE PRESCRIPTIONS
...
ALTER TABLE PROCEDUREEVENTS_MV
  DROP CONSTRAINT IF EXISTS procedureevents_mv_fk_subject_id;
ALTER TABLE PROCEDUREEVENTS_MV
...
-- hadm_id
ALTER TABLE PROCEDUREEVENTS_MV
  DROP CONSTRAINT IF EXISTS procedureevents_mv_fk_hadm_id;
ALTER TABLE PROCEDUREEVENTS_MV
...
-- icustay_id
ALTER TABLE PROCEDUREEVENTS_MV
  DROP CONSTRAINT IF EXISTS procedureevents_mv_fk_icustay_id;
ALTER TABLE PROCEDUREEVENTS_MV
...
-- cgid
ALTER TABLE PROCEDUREEVENTS_MV
  DROP CONSTRAINT IF EXISTS procedureevents_mv_fk_itemid;
ALTER TABLE PROCEDUREEVENTS_MV
...
-- cgid
ALTER TABLE PROCEDUREEVENTS_MV
  DROP CONSTRAINT IF EXISTS procedureevents_mv_fk_cgid;
ALTER TABLE PROCEDUREEVENTS_MV
...
ALTER TABLE PROCEDURES_ICD
  DROP CONSTRAINT IF EXISTS procedures_icd_fk_subject_id;
ALTER TABLE PROCEDURES_ICD
...
-- hadm_id
ALTER TABLE PROCEDURES_ICD
  DROP CONSTRAINT IF EXISTS procedures_icd_fk_hadm_id;
ALTER TABLE PROCEDURES_ICD
...
ALTER TABLE SERVICES
  DROP CONSTRAINT IF EXISTS services_fk_subject_id;
ALTER TABLE SERVICES
...
-- hadm_id
ALTER TABLE SERVICES
  DROP CONSTRAINT IF EXISTS services_fk_hadm_id;
ALTER TABLE SERVICES
...
ALTER TABLE TRANSFERS
  DROP CONSTRAINT IF EXISTS transfers_fk_subject_id;
ALTER TABLE TRANSFERS
...
-- hadm_id
ALTER TABLE TRANSFERS
  DROP CONSTRAINT IF EXISTS transfers_fk_hadm_id;
ALTER TABLE TRANSFERS
...
-- icustay_id
ALTER TABLE TRANSFERS
  DROP CONSTRAINT IF EXISTS transfers_fk_icustay_id;
ALTER TABLE TRANSFERS
